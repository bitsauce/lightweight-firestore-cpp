...
void FIRESTORE_EXPORT AddDescriptors_google_2ffirestore_2fv1_2fwrite_2eproto();
namespace google {
namespace firestore {
namespace v1 {
...
FIRESTORE_EXPORT const ::google::protobuf::EnumDescriptor* DocumentTransform_FieldTransform_ServerValue_descriptor();
