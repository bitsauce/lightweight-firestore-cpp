...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_google_2ffirestore_2fv1_2fwrite_2eproto FIRESTORE_EXPORT
...
struct FIRESTORE_EXPORT TableStruct_google_2ffirestore_2fv1_2fwrite_2eproto {
...
extern FIRESTORE_EXPORT const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2ffirestore_2fv1_2fwrite_2eproto;
namespace google {
namespace firestore {
namespace v1 {
class DocumentChange;
class DocumentChangeDefaultTypeInternal;
FIRESTORE_EXPORT extern DocumentChangeDefaultTypeInternal _DocumentChange_default_instance_;
class DocumentDelete;
class DocumentDeleteDefaultTypeInternal;
FIRESTORE_EXPORT extern DocumentDeleteDefaultTypeInternal _DocumentDelete_default_instance_;
class DocumentRemove;
class DocumentRemoveDefaultTypeInternal;
FIRESTORE_EXPORT extern DocumentRemoveDefaultTypeInternal _DocumentRemove_default_instance_;
class DocumentTransform;
class DocumentTransformDefaultTypeInternal;
FIRESTORE_EXPORT extern DocumentTransformDefaultTypeInternal _DocumentTransform_default_instance_;
class DocumentTransform_FieldTransform;
class DocumentTransform_FieldTransformDefaultTypeInternal;
FIRESTORE_EXPORT extern DocumentTransform_FieldTransformDefaultTypeInternal _DocumentTransform_FieldTransform_default_instance_;
class ExistenceFilter;
class ExistenceFilterDefaultTypeInternal;
FIRESTORE_EXPORT extern ExistenceFilterDefaultTypeInternal _ExistenceFilter_default_instance_;
class Write;
class WriteDefaultTypeInternal;
FIRESTORE_EXPORT extern WriteDefaultTypeInternal _Write_default_instance_;
class WriteResult;
class WriteResultDefaultTypeInternal;
FIRESTORE_EXPORT extern WriteResultDefaultTypeInternal _WriteResult_default_instance_;
}  // namespace v1
}  // namespace firestore
}  // namespace google
PROTOBUF_NAMESPACE_OPEN
template<> FIRESTORE_EXPORT ::google::firestore::v1::DocumentChange* Arena::CreateMaybeMessage<::google::firestore::v1::DocumentChange>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::DocumentDelete* Arena::CreateMaybeMessage<::google::firestore::v1::DocumentDelete>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::DocumentRemove* Arena::CreateMaybeMessage<::google::firestore::v1::DocumentRemove>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::DocumentTransform* Arena::CreateMaybeMessage<::google::firestore::v1::DocumentTransform>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::DocumentTransform_FieldTransform* Arena::CreateMaybeMessage<::google::firestore::v1::DocumentTransform_FieldTransform>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::ExistenceFilter* Arena::CreateMaybeMessage<::google::firestore::v1::ExistenceFilter>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::Write* Arena::CreateMaybeMessage<::google::firestore::v1::Write>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::WriteResult* Arena::CreateMaybeMessage<::google::firestore::v1::WriteResult>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace google {
namespace firestore {
namespace v1 {
...
FIRESTORE_EXPORT bool DocumentTransform_FieldTransform_ServerValue_IsValid(int value);
...
FIRESTORE_EXPORT const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* DocumentTransform_FieldTransform_ServerValue_descriptor();
template<typename T>
...
class FIRESTORE_EXPORT DocumentTransform_FieldTransform :
...
class FIRESTORE_EXPORT DocumentTransform :
...
class FIRESTORE_EXPORT WriteResult :
...
class FIRESTORE_EXPORT DocumentChange :
...
class FIRESTORE_EXPORT DocumentDelete :
...
class FIRESTORE_EXPORT DocumentRemove :
...
class FIRESTORE_EXPORT ExistenceFilter :
