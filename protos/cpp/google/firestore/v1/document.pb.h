...
#ifndef PROTOBUF_INCLUDED_google_2ffirestore_2fv1_2fdocument_2eproto
#define PROTOBUF_INCLUDED_google_2ffirestore_2fv1_2fdocument_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_google_2ffirestore_2fv1_2fdocument_2eproto FIRESTORE_EXPORT

// Internal implementation detail -- do not use these members.
struct FIRESTORE_EXPORT TableStruct_google_2ffirestore_2fv1_2fdocument_2eproto {
...
void FIRESTORE_EXPORT AddDescriptors_google_2ffirestore_2fv1_2fdocument_2eproto();
namespace google {
namespace firestore {
namespace v1 {
class ArrayValue;
class ArrayValueDefaultTypeInternal;
FIRESTORE_EXPORT extern ArrayValueDefaultTypeInternal _ArrayValue_default_instance_;
class Document;
class DocumentDefaultTypeInternal;
FIRESTORE_EXPORT extern DocumentDefaultTypeInternal _Document_default_instance_;
class Document_FieldsEntry_DoNotUse;
class Document_FieldsEntry_DoNotUseDefaultTypeInternal;
FIRESTORE_EXPORT extern Document_FieldsEntry_DoNotUseDefaultTypeInternal _Document_FieldsEntry_DoNotUse_default_instance_;
class MapValue;
class MapValueDefaultTypeInternal;
FIRESTORE_EXPORT extern MapValueDefaultTypeInternal _MapValue_default_instance_;
class MapValue_FieldsEntry_DoNotUse;
class MapValue_FieldsEntry_DoNotUseDefaultTypeInternal;
FIRESTORE_EXPORT extern MapValue_FieldsEntry_DoNotUseDefaultTypeInternal _MapValue_FieldsEntry_DoNotUse_default_instance_;
class Value;
class ValueDefaultTypeInternal;
FIRESTORE_EXPORT extern ValueDefaultTypeInternal _Value_default_instance_;
}  // namespace v1
}  // namespace firestore
namespace protobuf {
template<> FIRESTORE_EXPORT ::google::firestore::v1::ArrayValue* Arena::CreateMaybeMessage<::google::firestore::v1::ArrayValue>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::Document* Arena::CreateMaybeMessage<::google::firestore::v1::Document>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::Document_FieldsEntry_DoNotUse* Arena::CreateMaybeMessage<::google::firestore::v1::Document_FieldsEntry_DoNotUse>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::MapValue* Arena::CreateMaybeMessage<::google::firestore::v1::MapValue>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::MapValue_FieldsEntry_DoNotUse* Arena::CreateMaybeMessage<::google::firestore::v1::MapValue_FieldsEntry_DoNotUse>(Arena*);
template<> FIRESTORE_EXPORT ::google::firestore::v1::Value* Arena::CreateMaybeMessage<::google::firestore::v1::Value>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace firestore {
...
class FIRESTORE_EXPORT Document :
...
class FIRESTORE_EXPORT ArrayValue :
...
class FIRESTORE_EXPORT MapValue :
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_google_2ffirestore_2fv1_2fdocument_2eproto
