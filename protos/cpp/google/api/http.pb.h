...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_google_2fapi_2fhttp_2eproto FIRESTORE_EXPORT
...
struct FIRESTORE_EXPORT TableStruct_google_2fapi_2fhttp_2eproto {
...
extern FIRESTORE_EXPORT const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fapi_2fhttp_2eproto;
namespace google {
namespace api {
class CustomHttpPattern;
class CustomHttpPatternDefaultTypeInternal;
FIRESTORE_EXPORT extern CustomHttpPatternDefaultTypeInternal _CustomHttpPattern_default_instance_;
class Http;
class HttpDefaultTypeInternal;
FIRESTORE_EXPORT extern HttpDefaultTypeInternal _Http_default_instance_;
class HttpRule;
class HttpRuleDefaultTypeInternal;
FIRESTORE_EXPORT extern HttpRuleDefaultTypeInternal _HttpRule_default_instance_;
}  // namespace api
}  // namespace google
PROTOBUF_NAMESPACE_OPEN
template<> FIRESTORE_EXPORT ::google::api::CustomHttpPattern* Arena::CreateMaybeMessage<::google::api::CustomHttpPattern>(Arena*);
template<> FIRESTORE_EXPORT ::google::api::Http* Arena::CreateMaybeMessage<::google::api::Http>(Arena*);
template<> FIRESTORE_EXPORT ::google::api::HttpRule* Arena::CreateMaybeMessage<::google::api::HttpRule>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace google {
namespace api {
...
class FIRESTORE_EXPORT HttpRule :
...
class FIRESTORE_EXPORT CustomHttpPattern :
