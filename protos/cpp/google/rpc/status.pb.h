...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_google_2frpc_2fstatus_2eproto FIRESTORE_EXPORT
...
struct FIRESTORE_EXPORT TableStruct_google_2frpc_2fstatus_2eproto {
...
extern FIRESTORE_EXPORT const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2frpc_2fstatus_2eproto;
namespace google {
namespace rpc {
class Status;
class StatusDefaultTypeInternal;
FIRESTORE_EXPORT extern StatusDefaultTypeInternal _Status_default_instance_;
}  // namespace rpc
}  // namespace google
PROTOBUF_NAMESPACE_OPEN
template<> FIRESTORE_EXPORT ::google::rpc::Status* Arena::CreateMaybeMessage<::google::rpc::Status>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace google {
namespace rpc {
