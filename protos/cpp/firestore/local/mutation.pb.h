...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_firestore_2flocal_2fmutation_2eproto FIRESTORE_EXPORT
...
struct FIRESTORE_EXPORT TableStruct_firestore_2flocal_2fmutation_2eproto {
...
extern FIRESTORE_EXPORT const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_firestore_2flocal_2fmutation_2eproto;
namespace firestore {
namespace client {
class MutationQueue;
class MutationQueueDefaultTypeInternal;
FIRESTORE_EXPORT extern MutationQueueDefaultTypeInternal _MutationQueue_default_instance_;
class WriteBatch;
class WriteBatchDefaultTypeInternal;
FIRESTORE_EXPORT extern WriteBatchDefaultTypeInternal _WriteBatch_default_instance_;
}  // namespace client
}  // namespace firestore
PROTOBUF_NAMESPACE_OPEN
template<> FIRESTORE_EXPORT ::firestore::client::MutationQueue* Arena::CreateMaybeMessage<::firestore::client::MutationQueue>(Arena*);
template<> FIRESTORE_EXPORT ::firestore::client::WriteBatch* Arena::CreateMaybeMessage<::firestore::client::WriteBatch>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace firestore {
namespace client {
...
class FIRESTORE_EXPORT MutationQueue :
...
class FIRESTORE_EXPORT WriteBatch :
