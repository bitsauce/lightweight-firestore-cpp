...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_firestore_2flocal_2ftarget_2eproto FIRESTORE_EXPORT
...
struct FIRESTORE_EXPORT TableStruct_firestore_2flocal_2ftarget_2eproto {
...
extern FIRESTORE_EXPORT const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_firestore_2flocal_2ftarget_2eproto;
namespace firestore {
namespace client {
class Target;
...
FIRESTORE_EXPORT extern TargetGlobalDefaultTypeInternal _TargetGlobal_default_instance_;
}  // namespace client
}  // namespace firestore
PROTOBUF_NAMESPACE_OPEN
template<> FIRESTORE_EXPORT ::firestore::client::Target* Arena::CreateMaybeMessage<::firestore::client::Target>(Arena*);
template<> FIRESTORE_EXPORT ::firestore::client::TargetGlobal* Arena::CreateMaybeMessage<::firestore::client::TargetGlobal>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace firestore {
namespace client {
...
class FIRESTORE_EXPORT TargetGlobal :
