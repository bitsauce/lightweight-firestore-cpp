...
#ifndef PROTOBUF_INCLUDED_firestore_2flocal_2fmaybe_5fdocument_2eproto
#define PROTOBUF_INCLUDED_firestore_2flocal_2fmaybe_5fdocument_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_firestore_2flocal_2fmaybe_5fdocument_2eproto FIRESTORE_EXPORT

// Internal implementation detail -- do not use these members.
struct FIRESTORE_EXPORT TableStruct_firestore_2flocal_2fmaybe_5fdocument_2eproto {
...
void FIRESTORE_EXPORT AddDescriptors_firestore_2flocal_2fmaybe_5fdocument_2eproto();
namespace firestore {
namespace client {
class MaybeDocument;
class MaybeDocumentDefaultTypeInternal;
FIRESTORE_EXPORT extern MaybeDocumentDefaultTypeInternal _MaybeDocument_default_instance_;
class NoDocument;
class NoDocumentDefaultTypeInternal;
FIRESTORE_EXPORT extern NoDocumentDefaultTypeInternal _NoDocument_default_instance_;
class UnknownDocument;
class UnknownDocumentDefaultTypeInternal;
FIRESTORE_EXPORT extern UnknownDocumentDefaultTypeInternal _UnknownDocument_default_instance_;
}  // namespace client
}  // namespace firestore
namespace google {
namespace protobuf {
template<> FIRESTORE_EXPORT ::firestore::client::MaybeDocument* Arena::CreateMaybeMessage<::firestore::client::MaybeDocument>(Arena*);
template<> FIRESTORE_EXPORT ::firestore::client::NoDocument* Arena::CreateMaybeMessage<::firestore::client::NoDocument>(Arena*);
template<> FIRESTORE_EXPORT ::firestore::client::UnknownDocument* Arena::CreateMaybeMessage<::firestore::client::UnknownDocument>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace firestore {
namespace client {
...
class FIRESTORE_EXPORT NoDocument :
 ...
 public:
  ...
  NoDocument* New(::google::protobuf::Arena* arena) const final {
...
class FIRESTORE_EXPORT UnknownDocument :
 ...
 public:
  ...
  UnknownDocument* New(::google::protobuf::Arena* arena) const final {
...
class FIRESTORE_EXPORT MaybeDocument :
 ...
 public:
  ...
  MaybeDocument* New(::google::protobuf::Arena* arena) const final {
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_firestore_2flocal_2fmaybe_5fdocument_2eproto
