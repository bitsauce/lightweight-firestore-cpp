...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_google_2fprotobuf_2fany_2eproto FIRESTORE_EXPORT

// Internal implementation detail -- do not use these members.
struct FIRESTORE_EXPORT TableStruct_google_2fprotobuf_2fany_2eproto {
...
void FIRESTORE_EXPORT AddDescriptors_google_2fprotobuf_2fany_2eproto();
namespace google {
namespace protobuf {
class Any;
class AnyDefaultTypeInternal;
FIRESTORE_EXPORT extern AnyDefaultTypeInternal _Any_default_instance_;
template<> FIRESTORE_EXPORT ::google::protobuf::Any* Arena::CreateMaybeMessage<::google::protobuf::Any>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace protobuf {
