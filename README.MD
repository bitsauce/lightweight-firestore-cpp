...
Now Firestore should compile, and you the tests should run succesfully,
provided you change the default `project_id` in `Tests/Main.cpp` to match the `project_id`
of your Firestore database.
